			...
			<div class="form_section">
				...
				<div class="form_section_content">
					<select name="nationId">
						...
						<option value="01" ${authorInfo.nationId eq '01' ? 'selected' : ''}>Made in Korea</option>
						<option value="02" ${authorInfo.nationId eq '02' ? 'selected' : ''}>Made in other countries</option>
					</select>
				</div>
			</div>
			<div class="form_section">
