        ...
        <form action="/admin/goodsEnroll" method="post" id="enrollForm">
            ...
            <div class="form_section">
                ...
                <div class="form_section_content">
                    ...
                    <!-- 수정: authorId 값을 숫자로 변환하여 전달 -->
                    <input id="authorId_input" name="authorId" type="hidden" value="${authorVO.authorId != null ? authorVO.authorId : 0}">
            ...
            <div class="form_section">
                ...
                <div class="form_section_content">
                    <!-- 수정: 'publeYear' 필드의 값을 올바른 날짜 형식으로 변경 -->
                    <input name="publeYear" autocomplete="off" readonly="readonly" value="${beanVO.publeYear}">
...
<script>
    ...
    $("#enrollBtn").on("click",function(e){
        ...
        let beanIntro = $(".bit textarea").val(); // 수정: textarea 값을 가져옴
        let beanContents = $(".bct textarea").val(); // 수정: textarea 값을 가져옴
