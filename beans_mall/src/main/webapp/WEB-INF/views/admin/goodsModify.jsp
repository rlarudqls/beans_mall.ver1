	...
	<div class="admin_content_wrap">
			...
			<form action="/admin/goodsModify" method="post" id="modifyForm">
				<div class="form_section">
					...
					<div class="form_section_content">
						<input name="beanName" value="${goodsInfo.beanName}"> <span
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input name="beanPrice" value="${goodsInfo.beanPrice}"> <span
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input name="beanStock" value="${goodsInfo.beanStock}"> <span
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input id="discount_interface" maxlength="2" value="0"> <input
							name="beanDiscount" type="hidden"
							value="${goodsInfo.beanDiscount}"> <span class="step_val">할인
							가격 : <span class="span_discount"></span>
						</span> <span class="ck_warn beanDiscount_warn">1~99 숫자를 입력해주세요.</span>
					</div>
				</div>
				<div class="form_section">
					<div class="form_section_title">
					...
					<div class="form_section_content bit">
						<textarea name="beanIntro" id="beanIntro_textarea">${goodsInfo.beanIntro}</textarea>
				...
				<div class="form_section">
					...
					<div class="form_section_content bct">
						<textarea name="beanContents" id="beanContents_textarea">${goodsInfo.beanContents}</textarea>
		...
		<form id="moveForm" action="/admin/goodsDetail" method="get">
			<input type="hidden" name="pageNum" value="${cri.pageNum}"> <input
				...
				type="hidden" name='beanId' value="${goodsInfo.beanId}">
		</form>
	</div>
...
<body>
	<h1>Bean 수정 페이지</h1>
	<form id="modifyForm" action="/admin/goodsModify" method="post">
		<!-- form content -->
	</form>
	<script>
		/* 배열 초기화 */
		...
		let targetCate2 = '';
		let targetCate3 = '${beanInfo.cateCode}';
		...
		$.getJSON("/getAttachList", {beanId: beanId}, function (arr) {
			...
			if (arr.length === 0) {
				...
				str += "<img src='/resources/img/beanNoImage.png'>";
				str += "</div>";
	...
	$("#discount_interface").on("propertychange change keyup paste input", function(){
		...
		let beanPrice = $("input[name='beanPrice']").val();			// 원가
		let discountPrice = beanPrice * (1 - sendDiscountRate);		// 할인가격
	...
	$("#deleteBtn").on("click", function(e){
		...
		moveForm.append('<input type="hidden" name="beanId" value="${beanInfo.beanId}">');
