					...
					<table class="type_list">
						...
						<tbody id="searchList>">
							<c:forEach items="${list}" var="list">
								<tr>
									<td class="image">
										<div class="image_wrap" data-beanid="${list.imageList[0].beanId}" data-path="${list.imageList[0].uploadPath}" data-uuid="${list.imageList[0].uuid}" data-filename="${list.imageList[0].fileName}">
											<img>
										</div>									
									</td>
									<td class="detail">
										...
										<div class="author">
											${list.authorName} | ${list.publisher} | ${list.publeYear}
										</div>
									</td>
									<td class="info">
										<div class="author">
									...
									<td class="price">
										<div class="org_price">
											<del>
												<fmt:formatNumber value="${list.beanPrice}" pattern="#,### 원" />
											</del>
										</div>
										<div class="sell_price">
											<strong>
												<fmt:formatNumber value="${list.beanPrice * (1-list.beanDiscount)}" pattern="#,### 원" />
											</strong>
										</div>
									</td>
									<td class="option"></td>
