		...
		<div class="content_area">
			...
			<div class="content_top">
				<div class="ct_left_area">
					<div class="image_wrap" data-beanid="${goodsInfo.imageList[0].beanId}" data-path="${goodsInfo.imageList[0].uploadPath}" data-uuid="${goodsInfo.imageList[0].uuid}" data-filename="${goodsInfo.imageList[0].fileName}">
						<img>
					</div>				
				</div>
				<div class="ct_right_area">
					...
					<div class="price">
						<div class="sale_price">정가 : <fmt:formatNumber value="${goodsInfo.beanPrice}" pattern="#,### 원" /></div>
						<div class="discount_price">
							판매가 : <span class="discount_price_number"><fmt:formatNumber value="${goodsInfo.beanPrice - (goodsInfo.beanPrice*goodsInfo.beanDiscount)}" pattern="#,### 원" /></span> 
							[<fmt:formatNumber value="${goodsInfo.beanDiscount*100}" pattern="###" />% 
							<fmt:formatNumber value="${goodsInfo.beanPrice*goodsInfo.beanDiscount}" pattern="#,### 원" /> 할인]
						</div>
						<div>
			...
			<div class="content_middle">
				<div class="bean_intro">
					${goodsInfo.beanIntro}
				</div>
				<div class="bean_content">
					${goodsInfo.beanContents }
				</div>
			</div>
			<div class="line">
			</div>				
			...
			<form action="/order/${member.memberId}" method="get" class="order_form">
				<input type="hidden" name="orders[0].beanId" value="${goodsInfo.beanId}">
				<input type="hidden" name="orders[0].beanCount" value="">
			</form>	
		</div>
...
$(document).ready(function(){
	...
	$.getJSON("/reply/list", {beanId : beanId}, function(obj){
...
// 장바구니 추가 버튼
	...
	$(".btn_buy").on("click", function(){
		...
		$(".order_form").find("input[name='orders[0].beanCount']").val(beanCount);
		$(".order_form").submit();
	});
		...
		$.ajax({
			...
			success : function(result){
				...
				if(result === '1'){
					...
					let popUrl = "/replyEnroll/" + memberId + "?beanId=" + beanId;
					console.log(popUrl);
	...
	/* 리뷰 수정 버튼 */
	 $(document).on('click', '.update_reply_btn', function(e){
			...
			let popUrl = "/replyUpdate?replyId=" + replyId + "&beanId=" + '${goodsInfo.beanId}' + "&memberId=" + '${member.memberId}';	
			let popOption = "width = 490px, height=490px, top=300px, left=300px, scrollbars=yes"	
