					...
					<table class="goods_table">
						...
						<tbody>
							<c:forEach items="${orderList}" var="ol">
								<tr>
									<td>
										<div class="image_wrap" data-beanid="${ol.imageList[0].beanId}" data-path="${ol.imageList[0].uploadPath}" data-uuid="${ol.imageList[0].uuid}" data-filename="${ol.imageList[0].fileName}">
											<img>
										</div>
									</td>
									<td>${ol.beanName}</td>
									<td class="goods_table_price_td">
										<fmt:formatNumber value="${ol.salePrice}" pattern="#,### 원" /> | 수량 ${ol.beanCount}개
										<br><fmt:formatNumber value="${ol.totalPrice}" pattern="#,### 원" />
										<br>[<fmt:formatNumber value="${ol.totalPoint}" pattern="#,### 원" />P]
										<input type="hidden" class="individual_beanPrice_input" value="${ol.beanPrice}">
										<input type="hidden" class="individual_salePrice_input" value="${ol.salePrice}">
										<input type="hidden" class="individual_beanCount_input" value="${ol.beanCount}">
										<input type="hidden" class="individual_totalPrice_input" value="${ol.salePrice * ol.beanCount}">
										...
										<input type="hidden" class="individual_beanId_input" value="${ol.beanId}">
									</td>
								</tr>							
							</c:forEach>
