	...
	<section class="product-list">
		...
		<div class="product">
			...
			<button
				...
				<!-- 여러 포트를 실행시켰더니 서버가 너무 느려졌습니다, 잠시 꺼두겠습니다.. -->
			<!-- <a href="http://3.39.110.53:8081/main" class="visit-button">방문하기</a> -->
			<!-- bean's_mall.ver2와 작업물은 똑같기 때문에 http://3.39.110.53:8080로 변경했습니다. -->
			
			
			
			
			<a href="http://3.39.110.53:8080" class="visit-button">방문하기</a>
		...
		<div class="product">
			...
			<button
				...
				알아보기</button>
				<!-- 여러 포트를 실행시켰더니 서버가 너무 느려졌습니다, 잠시 꺼두겠습니다.. -->
			<!-- <a href="http://3.39.110.53:8082" class="visit-button">방문하기</a> -->
		...
		document
				.addEventListener(
						...
						function() {
							...
							const product1UpdateDate = "2023-10-30";
							const product2UpdateDate = "2023-10-26";
							const product3UpdateDate = "2023-08-29";
							const product4UpdateDate = "2021-12-26";
							const product5UpdateDate = "2022-12-22";
