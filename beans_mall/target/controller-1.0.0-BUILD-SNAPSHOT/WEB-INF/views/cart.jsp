      ...
      <li><a href="/board/kkb_boardList">Q&A 게시판</a></li>		
		...
		<div class="content_area">
						...
						<c:forEach items="${cartInfo}" var="ci">
							<tr>
								<td class="td_width_1 cart_info_td">
									...
									<input type="hidden" class="individual_beanPrice_input" value="${ci.beanPrice}">
									<input type="hidden" class="individual_salePrice_input" value="${ci.salePrice}">
									<input type="hidden" class="individual_beanCount_input" value="${ci.beanCount}">
									<input type="hidden" class="individual_totalPrice_input" value="${ci.salePrice * ci.beanCount}">
									<input type="hidden" class="individual_point_input" value="${ci.point}">
									<input type="hidden" class="individual_totalPoint_input" value="${ci.totalPoint}">
									<input type="hidden" class="individual_beanId_input" value="${ci.beanId}">								
								</td>
								<td class="td_width_2">
									<div class="image_wrap" data-beanid="${ci.imageList[0].beanId}" data-path="${ci.imageList[0].uploadPath}" data-uuid="${ci.imageList[0].uuid}" data-filename="${ci.imageList[0].fileName}">
										<img>
									</div>								
								</td>
								<td class="td_width_3">${ci.beanName}</td>
								<td class="td_width_4 price_td">
									<del>정가 : <fmt:formatNumber value="${ci.beanPrice}" pattern="#,### 원" /></del><br>
								...
								<td class="td_width_4 table_text_align_center">
									<div class="table_text_align_center quantity_div">
										<input type="text" value="${ci.beanCount}" class="quantity_input">	
								...
								<td class="td_width_4 table_text_align_center">
									<fmt:formatNumber value="${ci.salePrice * ci.beanCount}" pattern="#,### 원" />
								</td>
								<td class="td_width_4 table_text_align_center">
			...
			<form action="/cart/update" method="post" class="quantity_update_form">
				...
				<input type="hidden" name="beanCount" class="update_beanCount">
...
function setTotalInfo(){
	...
	$(".cart_info_td").each(function(index, element){
		...
		if($(element).find(".individual_cart_checkbox").is(":checked") === true){	//체크여부
			...
			// 총 갯수
			totalCount += parseInt($(element).find(".individual_beanCount_input").val());
			// 총 종류
			totalKind += 1;
			// 총 마일리지
...
$(".order_btn").on("click", function(){
	...
	$(".cart_info_td").each(function(index, element){
		...
		if($(element).find(".individual_cart_checkbox").is(":checked") === true){	//체크여부
			...
			let beanId = $(element).find(".individual_beanId_input").val();
			let beanCount = $(element).find(".individual_beanCount_input").val();
